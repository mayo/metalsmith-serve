...
function _onError(options, staticServer, request, response, err) {
...
function _serve(options, staticServer, request, response) {
  var onError = _.partial(_onError, options, staticServer, request, response);
  request
    .addListener('end', _.bind(staticServer.serve, staticServer, request, response, onError))
    .resume();
}
...
function createServer(options, metalsmith, cb) {
  ...
  var server = http.createServer(_.partial(_serve, options, staticServer));
